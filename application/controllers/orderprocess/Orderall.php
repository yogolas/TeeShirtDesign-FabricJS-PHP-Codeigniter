...
public function __construct()
        {
                parent::__construct();
              $this->load->model('orderprocess/orderall_model');
...
exit;
	...
	{
		$data['title'] = 'Campaign Process';
		$this->orderprocess('orderprocess/orderall',$data);
	}
...
$email = $this->orderall_model->Getorderprinting($data);
...
$getorder = $this->orderall_model->Getorderprinting2($data2);
...
$txt .= "<td width='33%' align='right'>".number_format($value2['qty'] * $value2['price'])."</td></tr>";
	...
	$to = $emails;
	$subject = 'Your Omerka order is printing!';
	$dataemail = "
<html>
<head>
