...
public function Getcampaign()
	...
	{
		$query = $this->db->query("SELECT *, from_unixtime(adddate,'%d-%m-%Y %H:%i:%s') as adddate2 FROM campaign WHERE campaign_status='5' ORDER BY adddate ASC");
		return json_encode($query->result_array(), JSON_UNESCAPED_UNICODE );
	}
...
public function Getordershiping($data)
	{
	...
	public function Getordershiping2($data)
	{
